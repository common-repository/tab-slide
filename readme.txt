...
2. `tab_slide_check_device`
3. `tab_slide_check_credentials`
4. `tab_slide_url`
5. `tab_slide_include_container_html`
      
* Actions:
1. `tab_slide_init_check`
2. `tab_slide_check_credentials`
3. `tab_slide_check_device`
4. `tab_slide_load_html_container_template`
5. `tab_slide_shortcode`
6. `tab_slide_shortcode_hide`
7. `tab_slide_front_end_scripts`
8. `tab_slide_front_end_styles`
9. `tab_slide_loaded`
10. `save_tab_slide_settings`
...
* bugfix: WordPress SEO compatibility
